<template>
    <div class="row">
        <div class="col">
            ...
            <p v-if="status == 'LOAD'">
                Đây là lịch học đã được lưu sẵn - <button @click="deleteLichHoc()" class="btn btn-danger">Tạo lịch mới</button>
            </p>
            <div class="text-right my-2">
                <button
                    class="btn btn-warning"
                    v-if="(state == 'EDIT') || (status == 'NEW')"
                    @click="saveData()"
                >   
                Lưu lại
                </button>
                        ...
                        >
                            ...
                            <td class="text-center">
                                ...
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" :name="'optradio' + item.date" value="CO" v-model="item.state"
                                        @change="change"
                                    >Bình thường
                                </label>
                                </div>
                                <div class="form-check-inline">
                                <label class="form-check-label">
                                    <input type="radio" class="form-check-input" :name="'optradio' + item.date" value="KHONG" v-model="item.state"
                                        @change="change"
                                    >Nghỉ học
                                </label>
                                </div>
