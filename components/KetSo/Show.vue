            ...
            <div class="row mt-1">
                ...
                <div class="col-11">
                    <p>Họ và tên học sinh: <strong>{{ item.hocsinh.name }}</strong>
                        <br>Lớp: <strong>{{ item.lophoc.name }}</strong></p>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <table class="">
                        <thead class="text-center text-danger">
                            <tr>
                                ...
                                <th style="width: 20%">Chi tiết thu</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="tb-col-1">Phí phát sinh</td>
                                <td class="tb-col-2">{{ numberWithCommas(item.data.khac) }}</td>
                                <td class="tb-col-3">{{ item.data.note }}</td>
                            </tr>
                ...
                <div class="col">
                    ...
                    >
                        <div class="col">
                            ...
                            <table class="table table-bordered table-striped">
                                <tr
                                v-for="hocsinh in item.hocsinh.parent.hocsinhs"
                                >
                                    <td>{{ hocsinh.name }}</td>
                                    <td
                                        v-if="hocsinh.lophoc"
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <table class="table table-bordered table-striped">
                                <tr
                                    v-for="phone in item.hocsinh.parent.phone"
                                >
                                    <td>{{ phone.name }}</td>
                                    <td>{{ phone.number }}</td>
                                    <td>
