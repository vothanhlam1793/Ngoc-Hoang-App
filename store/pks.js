    ...
    client
      ...
      .then((data) => {
        ...
        if (data.data.createOrUpdatePhieuKetSo.message == "SUCCESS") {
          data.data.createOrUpdatePhieuKetSo.data.items.forEach(function (
            item
          ) {
            try {
          ...
          console.log(
            data.data.createOrUpdatePhieuKetSo.message,
            data.data.createOrUpdatePhieuKetSo.content
          );
        }
      })
      .then((err) => {
